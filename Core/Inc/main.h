...
#define bttn_settings_2_Pin GPIO_PIN_8
#define bttn_settings_2_GPIO_Port GPIOA
#define bttn_usb_led_Pin GPIO_PIN_11
#define bttn_usb_led_GPIO_Port GPIOA
#define fan_n_power_on_Pin GPIO_PIN_12
#define fan_n_power_on_GPIO_Port GPIOA
#define pwm_chrgr_pwr_Pin GPIO_PIN_15
#define pwm_chrgr_pwr_GPIO_Port GPIOA
#define pwm_fan_pwr_Pin GPIO_PIN_3
#define pwm_fan_pwr_GPIO_Port GPIOB
